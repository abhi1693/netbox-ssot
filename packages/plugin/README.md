...
The selectable NetBox target boundary covers portable Core Data Sources, every public writable NetBox 4.6 DCIM and
Circuits resource, and the portable Users access-control graph through dependency-closed datasets: Data Sources, Users,
Groups, Object Permissions, geography; device, module, rack, and circuit catalogs; component templates; racks and
...
Django permissions, private UserConfig preferences, Owner membership bridges, Data Source credentials, unknown backend
parameters, generated files and synchronization/job state, Device IP/cluster assignments, Interface IPAM and wireless
policy fields, VM-interface MAC assignments, wireless cable endpoints, custom fields, contacts, and images are outside
this provider-owned boundary. Only the Git branch parameter is portable; destination-only Data Source parameters are
preserved. New users receive unusable passwords. Circuit Terminations are supported as cable endpoints. Records that
