...
from . import circuits, dcim, users

RESOURCE_KINDS: Final = dcim.DCIM_RESOURCE_KINDS | circuits.CIRCUITS_RESOURCE_KINDS | users.USERS_RESOURCE_KINDS
ATTRIBUTE_FIELDS: Final = {
    **dcim.ATTRIBUTE_FIELDS,
    **circuits.CIRCUITS_ATTRIBUTE_FIELDS,
    **users.USERS_ATTRIBUTE_FIELDS,
}
EXTRA_ATTRIBUTE_FIELDS: Final = {**dcim.EXTRA_ATTRIBUTE_FIELDS, **users.USERS_EXTRA_ATTRIBUTE_FIELDS}
