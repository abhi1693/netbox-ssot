...
class UniFiProviderDefinition:
    @property
    def manifest(self) -> ProviderManifest:
        return _manifest()


def provider_definition() -> UniFiProviderDefinition:
    return UniFiProviderDefinition()


__all__ = ["UniFiProviderDefinition", "provider_definition"]
